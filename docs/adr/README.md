...
| [ADR-0003](0003-phase-1-privacy-threat-model-and-metadata-boundary.md) | Accepted | Phase 1 privacy threat model and server-visible metadata boundary. |
...
| [ADR-0006](0006-phase-1-device-identity-provisioning-and-secure-key-storage.md) | Proposed | Phase 1 device identity, provisioning and secure key storage. |
